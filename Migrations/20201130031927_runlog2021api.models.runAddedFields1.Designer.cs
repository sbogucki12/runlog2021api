...
namespace runlog2021api.Migrations
{
    ...
    [Migration("20201130031927_runlog2021api.models.runAddedFields1")]
    partial class runlog2021apimodelsrunAddedFields1
    {
            ...
            modelBuilder.Entity("runlog2021api.Models.Run", b =>
                {
                    ...
                    b.Property<double>("SleepToBedTime")
                        .HasColumnType("float");

                    b.Property<double>("SleepWakeTime")
                        .HasColumnType("float");
